...
setMode( mode )
{
	...
	if ( mode == "comp_public" )
	{
		...
		game["PROMOD_MODE_HUD"] = "^4Соревновательный ^3Паблик";
		pub();
	}
	else if ( mode == "comp_public_hc" )
	{
		...
		game["PROMOD_MODE_HUD"] = "^4Соревновательный ^3Паблик ^6HC";
		pub();
	}
	else if ( mode == "custom_public" )
	{
		...
		game["CUSTOM_MODE"] = 1;
		game["PROMOD_MATCH_MODE"] = "pub";
		game["PROMOD_MODE_HUD"] = "^4Пользовательский ^3Паблик";
	...
	{
		promod\comp::main();
		game["PROMOD_MODE_HUD"] = "^4Стратегический ^3Режим";
	...
	if( game["PROMOD_PB_OFF"] && getDvarInt( "sv_cheats" ) && !getDvarInt( "sv_punkbuster" ) )
		game["PROMOD_MODE_HUD"] += " ^1PB: ВЫКЛ & ЧИТЫ";
	else if( game["PROMOD_PB_OFF"] && !getDvarInt( "sv_punkbuster" ) )
		game["PROMOD_MODE_HUD"] += " ^1PB: ВЫКЛ";
	else if ( getDvarInt( "sv_cheats" ) )
		game["PROMOD_MODE_HUD"] += " ^1ЧИТЫ";
